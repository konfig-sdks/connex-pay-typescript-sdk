 ...
 * Customer data
 * @export
 * @interface SaleCreateTransactionRequestCardCustomer
 */
export interface SaleCreateTransactionRequestCardCustomer {
    /**
     * Mandatory for ACH Sales.  Min Length = 2 Max Length = 30
     * @type {string}
     * @memberof SaleCreateTransactionRequestCardCustomer
     */
    'FirstName'?: string;
    /**
     * Mandatory for ACH Sales. Min Length = 2 Max Length = 30
