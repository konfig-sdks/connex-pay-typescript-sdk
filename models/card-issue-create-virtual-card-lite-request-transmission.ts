 ...
 * @export
 * @interface CardIssueCreateVirtualCardLiteRequestTransmission
 */
export interface CardIssueCreateVirtualCardLiteRequestTransmission {
    /**
     ...
     * @type {Array<string>}
     * @memberof CardIssueCreateVirtualCardLiteRequestTransmission
     */
