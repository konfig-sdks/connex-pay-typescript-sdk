 ...
 * @export
 * @interface AuthenticationObtain3DSecureAuthenticationRequestCard
 */
export interface AuthenticationObtain3DSecureAuthenticationRequestCard {
    /**
     ...
     * @type {string}
     * @memberof AuthenticationObtain3DSecureAuthenticationRequestCard
     */
    'CardNumber'?: string;
    /**
