 ...
 * @export
 * @interface CardIssuanceCreateVirtualCardRequestTransmission
 */
export interface CardIssuanceCreateVirtualCardRequestTransmission {
    /**
     ...
     * @type {Array<string>}
     * @memberof CardIssuanceCreateVirtualCardRequestTransmission
     */
