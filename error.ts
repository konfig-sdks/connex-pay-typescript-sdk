...
/**
 * This class provides a wrapper for network errors when making requests to ConnexPay Reporting API
 */
export class ConnexPayError extends Error {
  /**
   * The response body
   */
